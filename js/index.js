...
document.addEventListener('DOMContentLoaded', function () {
    ...
    telegramDiv.addEventListener('click', function () {
        window.open('https://t.me/zerkeysosad', '_blank');
    });
});
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    telegramDiv.addEventListener('click', function () {
        window.open('https://github.com/quangck9988', '_blank');
    });
});
document.addEventListener('DOMContentLoaded', function () {
    var telegramDiv = document.querySelector('.Facebook');
    telegramDiv.addEventListener('click', function () {
        window.open('https://www.facebook.com/zerkey.0101', '_blank');
    });
});
document.addEventListener('DOMContentLoaded', function () {
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    telegramDiv.addEventListener('click', function () {
        window.open('https://www.tiktok.com/@noxusscrew', '_blank');
    });
});
document.addEventListener('DOMContentLoaded', function () {
    var telegramDiv = document.querySelector('.Youtube');
    telegramDiv.addEventListener('click', function () {
        window.open('https://www.youtube.com/channel/UC0UE0e5d1W8Y1rX123HBeiw', '_blank');
    });
});
document.addEventListener('DOMContentLoaded', function () {
...
console.log('%c- Có vẻ như bạn đang cố tình ăn cắp mã nguồn của tôi </ Minh Quang >.', 'color: #444; font-size: 25px; font-family: sans-serif;');
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var audio = new Audio('./audio/tranminhquang.mp3');
...
welcomeText.textContent = "Designed By MinhQuang =))";
